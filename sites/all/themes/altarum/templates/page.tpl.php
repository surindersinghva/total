...
<div class="wrapper">
<?php
if(isset($_GET['menu'])){if($_GET['menu'] == "true"){
	print "<nav id='primary_nav'>";}elseif($_GET['menu'] == "false"){print "<nav style='display:none;'>";}}else{print "<nav style='display:none;'>";}
?>		
			<ul>
			
				<li><a href="#">About Altarum</a></li>
...
<div id="menu-header">
<?php
if(isset($_GET['menu'])){if($_GET['menu'] == "true"){print "<a class='to_nav' href=\"?menu=false\">Close</a>";}elseif($_GET['menu'] == "false"){print "<a class='to_nav' href=\"?menu=true\">Menu</a>";}}else{print "<a class='to_nav' href=\"?menu=true\">Menu</a>";}
?>	
</div>
</div>
<div id="page" class="container <?php print $classes; ?>">
  ...
  <header<?php print $header_attributes; ?>>  
    <?php if ($site_logo || $site_name || $site_slogan): ?>
      ...
      <div<?php print $branding_attributes; ?>>
		<!-- region: Search -->
		<div id="search-block"><?php print render($page['search']); ?></div>
        <?php if ($site_logo): ?>
          <div id="logo">
            <?php print $site_logo; ?>
          </div>
  ...
  <?php if ($page['secondary_content']): ?>	
  	<div id="secondary-content"><?php print render($page['secondary_content']); ?></div>
  <?php endif; ?>	
	
  <!-- region: Preface One, Two and Three -->
  <div id="preface_wrap">
  	<div id="preface_one"><?php print render($page['preface_one']); ?></div>
  	<div id="preface_two"><?php print render($page['preface_two']); ?></div>
  	<div id="preface_three"><?php print render($page['preface_three']); ?></div>
  </div>
	
  <!-- region: Tertiary Content -->
  <div id="tertiary-content"><?php print render($page['tertiary_content']); ?></div>

  <!-- region: Footer -->
  <?php if ($page['footer']): ?>
    <footer<?php print $footer_attributes; ?>>
		<div id="footer-content"><?php print render($page['footer']); ?></div>
    </footer>
  <?php endif; ?>
